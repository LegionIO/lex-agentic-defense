...
`Defense::Extinction` is safety-critical: level 4 is irreversible and triggers cryptographic erasure via `lex-privatecore`. Level escalation requires authority-gated governance approval.
