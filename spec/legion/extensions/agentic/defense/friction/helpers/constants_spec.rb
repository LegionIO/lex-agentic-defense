...
RSpec.describe Legion::Extensions::Agentic::Defense::Friction::Helpers::Constants do
  let(:klass) { Class.new { include Legion::Extensions::Agentic::Defense::Friction::Helpers::Constants } }
