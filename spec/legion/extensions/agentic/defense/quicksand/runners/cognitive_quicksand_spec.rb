...
RSpec.describe Legion::Extensions::Agentic::Defense::Quicksand::Runners::CognitiveQuicksand do
  let(:runner) do
    obj = Object.new
  ...
  let(:engine) { Legion::Extensions::Agentic::Defense::Quicksand::Helpers::QuicksandEngine.new }
