...
RSpec.describe Legion::Extensions::Agentic::Defense::Whirlpool::Runners::CognitiveWhirlpool do
  let(:engine) { Legion::Extensions::Agentic::Defense::Whirlpool::Helpers::WhirlpoolEngine.new }
  let(:client) { Legion::Extensions::Agentic::Defense::Whirlpool::Client.new }
