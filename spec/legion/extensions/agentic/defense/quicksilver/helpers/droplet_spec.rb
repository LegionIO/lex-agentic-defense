...
RSpec.describe Legion::Extensions::Agentic::Defense::Quicksilver::Helpers::Droplet do
  ...
  describe '#initialize' do
    ...
    it 'defaults fluidity to FLUIDITY_BASE' do
      expect(droplet.fluidity).to eq(Legion::Extensions::Agentic::Defense::Quicksilver::Helpers::Constants::FLUIDITY_BASE)
    end
  ...
  describe '#merge!' do
    ...
    it 'combines mass with coalescence bonus' do
      bonus         = Legion::Extensions::Agentic::Defense::Quicksilver::Helpers::Constants::COALESCENCE_BONUS
  ...
  describe '#evaporate!' do
    it 'reduces mass by EVAPORATION_RATE' do
      original_mass = droplet.mass
      droplet.evaporate!
      expected = original_mass - Legion::Extensions::Agentic::Defense::Quicksilver::Helpers::Constants::EVAPORATION_RATE
      expect(droplet.mass).to be_within(0.001).of(expected)
    end
