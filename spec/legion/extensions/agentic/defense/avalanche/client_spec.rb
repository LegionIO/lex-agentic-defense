...
RSpec.describe Legion::Extensions::Agentic::Defense::Avalanche::Client do
  subject(:client) { described_class.new }

  describe '#initialize' do
    it 'creates an AvalancheEngine by default' do
      expect(client.engine).to be_a(Legion::Extensions::Agentic::Defense::Avalanche::Helpers::AvalancheEngine)
    end

    it 'accepts an injected engine' do
      custom_engine = Legion::Extensions::Agentic::Defense::Avalanche::Helpers::AvalancheEngine.new
