...
RSpec.describe Legion::Extensions::Agentic::Defense::Avalanche::Runners::CognitiveAvalanche do
  let(:engine) { Legion::Extensions::Agentic::Defense::Avalanche::Helpers::AvalancheEngine.new }
  let(:runner) { Object.new.extend(described_module) }

  def described_module
    Legion::Extensions::Agentic::Defense::Avalanche::Runners::CognitiveAvalanche
  end
  ...
  describe '#accumulate' do
    ...
    it 'uses default ACCUMULATION_RATE when not specified' do
      result = runner.accumulate(engine: engine)
      expect(result[:rate]).to eq(Legion::Extensions::Agentic::Defense::Avalanche::Helpers::Constants::ACCUMULATION_RATE)
    end
  end
  ...
  describe '#list_snowpacks' do
    ...
    it 'returns empty list when no snowpacks' do
      empty_engine = Legion::Extensions::Agentic::Defense::Avalanche::Helpers::AvalancheEngine.new
